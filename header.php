...
<meta http-equiv="<?php esc_attr_e('x-dns-prefetch-control'); ?>" content="<?php esc_attr_e('on'); ?>">
...
<div id="site-navbar" class="" role="banner">
  ...
  <figure id="navLogo" class="d-flex">
  ...
  <div class="navOverlay">
    <nav id="menu" class="overlay-content" aria-hidden="true" aria-labelledby="menu-toggle" role="navigation">
      <?php
        wp_nav_menu( array(
